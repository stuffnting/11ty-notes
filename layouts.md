...
These are links in layout files that will work for pages generated at any level in the directory structure. They are used in conjunction with `pathPrefix` setting and the htmlBasePlugin, or the [`url` filter](https://www.11ty.dev/docs/filters/url/)
